	...
	return (
		<Container>
			<TextSection>
				<h5>THE BUILDING</h5>
				<p>
					Introducing 1 Willoughby Square, Brooklyn's tallest office building. 1WSQ opens
					directly to the 1- acre Abolitionist Place park and climbs 34 stories above
					Brooklyn to offer unobstructed views of New York's skylines and waterways.
				</p>
			</TextSection>
			<ImageSection>
				<ResponsiveImage
			...
			<TextSection>
				<h5>THE OFFICES</h5>
				<p>
					The 14,500-square-foot floorplates at 1WSQ feature impressive column-free lease
					spans and 14-foot slab heights. Interiors and landscaped terraces overlook the
					new Willoughby Square Park and reveal 360-degree vistas from New York Harbor to
					Prospect Park. Multilevel occupants will experience connected floors with
					28-foot clearances.
				</p>
			</TextSection>
			<ImageSection>
			...
			<TextSection>
				<h5>THE ARCHITECT</h5>
				<p>
					FXCollaborative partner Dan Kaplan conceived 1WSQ as an industrial loft for the
					21st century, combining the exposed structure and daylighting of classic New
					York buildings with the energy-efficient systems and interior-exterior
					integration that today’s businesses demand. Kaplan’s design is so successful
					that FXCollaborative is departing Manhattan to reestablish its headquarters on
					three floors of 1WSQ.
				</p>
			</TextSection>
			<ImageSection>
				<ResponsiveImage

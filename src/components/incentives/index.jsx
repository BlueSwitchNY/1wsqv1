...
const BigNum = styled.span`
	...
	background-color: ${props => (props.table ? "rgba(113,152,217,0.4);" : "transparent")};
...
const Symbol = styled.span`
	...
	font-size: 48px;
	line-height: 48px;
	transform: ${props => (props.table ? "translateY(-10px)" : "translateY(8px)")};
	${mediaMin.tabletLandscape`
    font-size: 56px;
    line-height: 56px;
    `}
...
const FactRow = styled.div`
	...
	background-color: ${props => (props.odd ? "rgba(113,152,217,0.2);" : "transparent")};
	${mediaMin.tabletLandscape`
		...
		<IncentivesPageContainer>
			...
			<IncentivesPageContainerInner>
				<IncentivesContentLeft>
					...
					<p>
						1WSQ represents a rare coupling of New York City incentives with Class A new
						construction. Tax and energy savings create additional significant value for
						tenants.
					</p>
				</IncentivesContentLeft>
